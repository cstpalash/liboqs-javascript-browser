...
var wasmBinaryFile = 'liboqs-server.wasm';
...
/** @type {function(...*):?} */
var _GenerateKeyPair = Module["_GenerateKeyPair"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["GenerateKeyPair"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _GetPublicKey = Module["_GetPublicKey"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["GetPublicKey"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _Decaps = Module["_Decaps"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["Decaps"].apply(null, arguments)
};
