...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 16965552,
    DYNAMIC_BASE = 22208432,
    DYNAMICTOP_PTR = 16965392;
...
var INITIAL_INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 22216704;if (!Object.getOwnPropertyDescriptor(Module, 'INITIAL_MEMORY')) Object.defineProperty(Module, 'INITIAL_MEMORY', { configurable: true, get: function() { abort('Module.INITIAL_MEMORY has been replaced with plain INITIAL_INITIAL_MEMORY') } });
...
var wasmBinaryFile = 'liboqs-client.wasm';
...
// STATICTOP = STATIC_BASE + 16964528;
...
/** @type {function(...*):?} */
var _Prepare = Module["_Prepare"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["Prepare"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _Encaps = Module["_Encaps"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["Encaps"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _GetAesKey = Module["_GetAesKey"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["GetAesKey"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _GetCipherText = Module["_GetCipherText"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["GetCipherText"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _CleanupEncaps = Module["_CleanupEncaps"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["CleanupEncaps"].apply(null, arguments)
};
